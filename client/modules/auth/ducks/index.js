...
export const auth = (redirectPathname) => ({ type: AUTH_REQUEST, payload: { redirectPathname } });
export const signup = (email, password, redirectPathname) => ({ type: SIGNUP_REQUEST, payload: { email, password, redirectPathname }});
