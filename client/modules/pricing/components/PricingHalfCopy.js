...
const PricingHalfCopy = () => (
  <PricingHalfCopyContainer>
    <PricingHalfContainer>
      <PricingHalf>
        <ArtContainer>
          <SolidBallPurpleLeft />
      ...
      <PricingHalf>
        <PricingHalfNarrow right={true}>
          <PricingHalfHeader>45 days of active listing</PricingHalfHeader>
          <PricingHalfText>
    ...
    <PricingHalfContainer>
      <PricingHalf>
        <PricingHalfNarrow>
          <PricingHalfHeader>
            Reach the top tech talent in the world.
          </PricingHalfHeader>
          <PricingHalfText>
...
export default PricingHalfCopy;

const PricingHalfCopyContainer = styled.div`
  max-width: 960px;
  margin: 0 auto;
  width: 100%;
  display: block;
...
const PricingHalfContainer = styled.div`display: flex;`;

const PricingHalf = styled.div`
  width: 100%;
  display: block;
  padding: 75px 0 0;
  flex: 1;
...
const PricingHalfNarrow = styled.div`
  width: 82%;
  margin: ${props => (props.right ? '0 0 0 auto' : '0 auto 0 0')};
`;

const PricingHalfHeader = styled.h3`
  font-size: 48px;
  margin-bottom: 20px;
  font-weight: 900;
