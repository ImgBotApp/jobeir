...
const PrivacyPolicy = () => (
  <LegalContainer>
    ...
    <p style={{ opacity: '0.5' }}>Last updated: November 4th, 2017, 6:35pm</p>
    <br />
    <br />
    <section>
      <h2>
        Privacy statement - We ask our users for no more personal information
        than necessary.
      </h2>
      <p>
        Privacy and online safety are especially important to Jobeir. We offer a
        platform for the best companies to reach the best people in the world.
        We collect data businesses and applicants when they use our platform and
        services. This privacy policy describes how we collect, use and disclose
        Data.
      </p>
      <h2>A brief overview</h2>
      <p>
        Jobeir is commited to privacy for all users. We are an open platform
        that is here to help all that choose to use our platform and services.
        <br />
        We use and disclose personal information in accordance with this policy
        and the laws applicable to us in Canada;
        <br />
        We encourage you to contact us at any time if you have any questions in
    ...
    <section>
      ...
      <p>
        ...
        opportunity to say no. How do I withdraw my consent?
      </p>
      <p>
    ...
    <section>
      <h2>Section 5 - Age of consent</h2>
      <p>
    ...
    <section>
      <h2>Section 6 - Changes to this privacy policy</h2>
      <p>
    ...
    <section>
      ...
      <p>
        ...
        information contact our Privacy Compliance Officer at brotzky@gmail.com
        or by mail at Jobeir
      </p>
